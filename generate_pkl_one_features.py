...
from deepfold.inference.inference_pipeline import generate_pkl_features_from_fasta

#### USER CONFIGURATION ####

# Note: If your databases and toolkits were configured directly using the scripts 
# provided by Deepfold, the following code is directly useful. If not, you need 
# to customize your own paths of the downloaded databases and toolkits. 
# See README.md for more details.

# Define flags.
flags.DEFINE_string('fasta_path', None, 
