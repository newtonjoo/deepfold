...
// log base 2
inline float log2n(float x)  {return (x<=0? (float)(-100000):1.442695041*log(x));}
inline float log10n(float x) {return (x<=0? (float)(-100000):0.434294481*log(x));}
...
{
  static char str[100];
  float log10val = log10n(fabs(val));
  int neg = (val<0? 1: 0);
