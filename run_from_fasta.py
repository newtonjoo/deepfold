...
"""Full DeepFold protein structure prediction script."""
...
from deepfold.data import pipeline
from deepfold.data import templates
from deepfold.model import data
from deepfold.model import config
from deepfold.model import model
from deepfold.relax import relax


from deepfold.inference.inference_pipeline import predict_from_fasta
