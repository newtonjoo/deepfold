...
class MmcifObject:
  ...
  raw_string: Any
  chain_id_map:  Mapping[fid, cid]  # by newton
...
def parse(*,
  ...
  try:
    ...
    author_to_mmcif_chain_id = {}       # by newton
    ...
    for atom in _get_atom_site_list(parsed_info):
      ...
      author_to_mmcif_chain_id[atom.author_chain_id] = atom.mmcif_chain_id       # by newton
    ...
    mmcif_object = MmcifObject(
        ...
        chain_id_map=author_to_mmcif_chain_id)
