...
"""Functions for building the input features for the deepfold model."""
...
from deepfold.data.tools import hhblits
from deepfold.data.tools import hhsearch
from deepfold.data.tools import jackhmmer
import numpy as np
...
class DataPipeline:
  ...
  def process(self, input_fasta_path: str, msa_output_dir: str) -> FeatureDict:
    ...
    #   query_pdb_code=None,
    pid = input_fasta_path.split('/')[-1].split('.')[0][:4]         # by newton
    templates_result = self.template_featurizer.get_templates(
        query_sequence=input_sequence,
        query_pdb_code=pid,                                         # by newton to exclude same pdb
