...
"""Label Preprocessing pipeline for training Deepfold."""
...
from deepfold.model.all_atom import atom37_to_frames
from deepfold.model.all_atom import atom37_to_torsion_angles
from deepfold.model.modules \
    import pseudo_beta_fn as pseudo_beta_fn_jnp
from deepfold.model.tf.data_transforms \
    import pseudo_beta_fn as pseudo_beta_fn_tf
from deepfold.model.tf.input_pipeline import compose
from deepfold.data.pipeline import FeatureDict
...
def process_labels(prot: FeatureDict) -> FeatureDict:
  from deepfold.model.tf.input_pipeline import process_tensors_from_config
  from deepfold.model.tf.proteins_dataset import np_to_tensor_dict
